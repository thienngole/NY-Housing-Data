...
hc_data$X_28c[hc_data$X_28c == 9999] <- NA
hc_data$X_28d2[hc_data$X_28d2 == 999] <- NA
hc_data$X_28d2[hc_data$X_28d2 == 998] <- NA
hc_data$X_28d2[hc_data$X_28d2 == 9999] <- NA
...
k_means_data$X_28c[k_means_data$X_28c == 9999] <- NA
k_means_data$X_28d2[k_means_data$X_28d2 == 999] <- NA
k_means_data$X_28d2[k_means_data$X_28d2 == 998] <- NA
k_means_data$X_28d2[k_means_data$X_28d2 == 9999] <- NA

k_means_data <- na.omit(k_means_data)
k_means_data
```
