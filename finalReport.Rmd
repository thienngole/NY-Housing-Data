...
hc_data <- select(data_part2, c(borough, pqi, hhinc, X_28c, X_28d2, X_30a, mgrent))
hc_data$borough[hc_data$borough == 1] <- "Bronx"
hc_data$borough[hc_data$borough == 2] <- "Brooklyn"
hc_data$borough[hc_data$borough == 3] <- "Manhattan"
hc_data$borough[hc_data$borough == 4] <- "Queens"
hc_data$borough[hc_data$borough == 5] <- "Staten Island"
