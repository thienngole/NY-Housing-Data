...
```{r}
my.reg <- lm(pqi ~ hhinc + X_30a + X_31b, data = all_data)
summary(my.reg)
```
...
#library(dplyr)_
data91_99 <- filter(all_data, year == 91 | year == 93 | year == 96 | year == 99 )
data02_17 <- filter(all_data, year == 2002 | year == 2005 | year == 2008 | year == 2011 | year == 2014| year == 2017)
...
all_data <- rbind(data91_99, data02_17)
```   

```{r}
all_data$X_30a[all_data$X_30a == 99999] <- NA # Not applicable (occupied rent free or owner occupied)
all_data$X_30a[all_data$X_30a == 99998] <- NA # Not reported

all_data$X_31b[all_data$X_31b == 99999] <- NA # Not applicable (occupied rent free or owner occupied)
all_data$X_31b[all_data$X_31b == 99998] <- NA # Not reported
```
   
```{r}
all_data$X_25c[all_data$X_25c == 2] <- 0  # NO toilet breakdown
all_data$X_25c[all_data$X_25c == 3] <- NA # NO toilet in the apartment
all_data$X_25c[all_data$X_25c == 8] <- NA # Not reported
all_data$X_25c[all_data$X_25c == 9] <- NA # Not applicable (No plumbing facilities)
```


```{r}
my.logreg <- glm(X_25c ~ hhinc + X_30a + X_31b, data = all_data)
summary(my.logreg)
```
